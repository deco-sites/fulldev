...
export default function AboutMe({
    title = "About Me",
    description = "Lorem ipsum dolor, sit amet consectetur adipisicing elit. Neque quis, placeat perspiciatis autem debitis enim! Rerum recusandae aut facilis corporis, natus architecto temporibus laudantium labore nostrum esse numquam alias aliquid.",
